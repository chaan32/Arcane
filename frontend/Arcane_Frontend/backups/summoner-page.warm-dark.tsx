...
const getProfileIconUrl = (profile: Profile | null): string => {
  if (profile?.profileIconId) {
    return `https://ddragon.leagueoflegends.com/cdn/${DDRAGON_VERSION}/img/profileicon/${profile.profileIconId}.png`;
  }
...
const getTierIconUrl = (rankTier?: string): string => {
  ...
  return tierName
    ? `https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-static-assets/global/default/images/ranked-emblems/emblem-${tierName}.png`
    : "";
};
...
export default function SummonerPage({
  ...
  return (
    <div
      data-summoner-page
      className="flex min-h-screen justify-center bg-[radial-gradient(circle_at_top_left,_#2a1a10_0%,_#0c0807_42%,_#070504_100%)] text-[#fff8ef]"
    >
      <div className="flex w-full max-w-6xl flex-col px-4 pb-8 pt-4 lg:pb-10 lg:pt-5">
        <div className="w-full">
          <div className="toss-profile-card flex flex-col rounded-[1.75rem] border border-[#3a2a22] bg-[#18110e] p-6 shadow-[0_20px_52px_rgba(0,0,0,0.36)]">
            <div className="mb-3.5 flex gap-2">
              <div className="rounded-full border border-[#f6ad55]/30 bg-[#2a1c12] px-3 py-1 text-xs font-bold text-[#ffd08a]">
                gold
              </div>
              <div className="rounded-full border border-[#f6ad55]/30 bg-[#2a1c12] px-3 py-1 text-xs font-bold text-[#ffd08a]">
                gold
            ...
            <div className="flex items-center">
                  ...
                  <img
                    ...
                    onError={(event) => {
                      if (
                        ...
                        event.currentTarget.src = profile.profileUrl;
                        return;
                      }

                      event.currentTarget.style.visibility = "hidden";
                    }}
                    className="rounded-[1.5rem] border border-[#4a3427] bg-[#241914] shadow-[0_14px_32px_rgba(0,0,0,0.36)]"
                  />
                ) : (
                  <div className="h-[110px] w-[110px] rounded-[1.5rem] border border-[#4a3427] bg-[#241914] shadow-[0_14px_32px_rgba(0,0,0,0.36)]" />
                )}
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 rounded-full bg-[#f59e0b] px-2 py-0.5 text-xs font-bold text-[#120d0a]">
              ...
              <div className="ml-6 flex flex-col">
                <div className="flex items-end">
                  ...
                  <div className="ml-1 text-2xl text-[#bda895]">
                    #{data?.tagLine}
                  </div>
                </div>
                <button className="mt-4 w-fit cursor-pointer rounded-full bg-[#f59e0b] px-5 py-2 text-sm font-bold text-[#120d0a] shadow-[0_12px_28px_rgba(245,158,11,0.28)] transition-colors hover:bg-[#fbbf24]">
                  전적 갱신
                </button>
              </div>
            </div>
        ...
        <div className="mt-3 flex flex-col gap-4 md:flex-row">
          <div className="toss-sidebar flex shrink-0 flex-col gap-3 md:w-[20rem]">
            {data?.soloRank.rankTier ? (
              <div className="flex flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                <div className="border-b border-[#3a2a22] px-5 py-3 text-sm font-semibold text-[#d1bca8]">
                  솔로랭크
                </div>
                <div className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    <img
                      src={getTierIconUrl(data?.soloRank.rankTier)}
                      alt={data?.soloRank.rankTier || "rank tier"}
                      width={62}
                      height={62}
                      onError={(event) => {
                        if (!event.currentTarget.dataset.fallback) {
                          event.currentTarget.dataset.fallback = "true";
                          event.currentTarget.src = getLegacyTierIconUrl(
                            data?.soloRank.rankTier
                          );
                          return;
                        }
                      ...
                      className="drop-shadow-[0_10px_18px_rgba(245,158,11,0.14)]"
                    />
                    <div className="flex min-w-0 flex-1 flex-col gap-2">
                      <div className="flex items-center justify-between gap-3 text-sm">
                        <div className="min-w-0 whitespace-nowrap font-bold text-[#f8fafc]">
                          {data?.soloRank.rankTier}
                        </div>
                        <div className="shrink-0 whitespace-nowrap text-xs font-semibold text-[#bda895]">
                      ...
                      <div className="flex items-center justify-between gap-3 text-sm">
                        ...
                        <div className="whitespace-nowrap text-[#bda895]">
                          승률{" "}
              ...
              <div className="flex justify-between rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] px-5 py-4 shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                <div className="font-semibold">솔로 랭크</div>
                <div className="text-[#bda895]">Unranked</div>
              </div>
            )}
            {data?.flexRank.rankTier ? (
              <div className="flex flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                ...
                <div className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    <img
                      src={getTierIconUrl(data?.flexRank.rankTier)}
                      alt={data?.flexRank.rankTier || "rank tier"}
                      width={62}
                      height={62}
                      onError={(event) => {
                        if (!event.currentTarget.dataset.fallback) {
            ...
            <div className="flex flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
              <ul className="flex gap-1.5 border-b border-[#3a2a22] p-3">
                <li className="flex cursor-pointer items-center justify-center rounded-full bg-[#f59e0b] px-3 py-1.5 text-sm font-bold text-[#120d0a] shadow-[0_10px_20px_rgba(245,158,11,0.22)]">
                  전체
                </li>
                <li className="flex cursor-pointer items-center justify-center rounded-full bg-[#241914] px-3 py-1.5 text-sm font-semibold text-[#d1bca8]">
                  솔로랭크
                </li>
                <li className="flex cursor-pointer items-center justify-center rounded-full bg-[#241914] px-3 py-1.5 text-sm font-semibold text-[#d1bca8]">
                  자유랭크
              ...
              <ul className="flex flex-col">
                <li className="flex px-5 py-3">
                  ...
                  />
                  <div className="ml-2.5 flex flex-col py-0.5">
                    <div className="font-semibold">판테온</div>
                    <div className="text-sm text-[#bda895]">2.75 KDA</div>
                  </div>
                  <div className="ml-auto flex flex-col text-right text-sm">
                    <div>50%</div>
                    <div className="text-[#bda895]">8게임</div>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-4 md:ml-0">
            <div className="flex gap-1.5">
              <div className="rounded-full bg-[#f59e0b] px-4 py-2 text-sm font-bold text-[#120d0a] shadow-[0_10px_20px_rgba(245,158,11,0.22)]">
                전체
              </div>
              <div className="rounded-full border border-[#3a2a22] bg-[#18110e] px-4 py-2 text-sm font-semibold text-[#d1bca8]">
                칼바람 나락
              </div>
              <div className="rounded-full border border-[#3a2a22] bg-[#18110e] px-4 py-2 text-sm font-semibold text-[#d1bca8]">
                자유랭크
            ...
            <div className="flex flex-col justify-between gap-2.5 md:flex-row md:items-start">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-4 rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] p-4 shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                  <div>
                    <img
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="text-sm text-[#bda895]">10승 10패</div>
                  </div>
                  <div className="flex flex-col">
                    <div className="font-bold">1.00 KDA</div>
                    <div className="text-sm text-[#bda895]">10/10/10</div>
                  </div>
                  <div className="flex flex-col">
                    <div className="font-bold text-[#fbbf24]">50</div>
                    <div className="text-sm text-[#bda895]">AI Score</div>
                  </div>
                </div>
                <div className="flex justify-between gap-2.5">
                  <div className="flex flex-1 flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] p-4 shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                    <div className="text-sm text-[#bda895]">AI 티어 예측</div>
                    <div className="mt-1 font-bold">Gold 2</div>
                  </div>
                  <div className="flex flex-1 flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] p-4 shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                    <div className="text-sm text-[#bda895]">팀운</div>
                    <div className="mt-1 font-bold">보통</div>
                  </div>
                </div>
              </div>
              <div className="flex flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] p-4 shadow-[0_16px_38px_rgba(0,0,0,0.3)]">
                ...
                <div className="flex flex-col">
                  <div className="mt-3 flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-sm text-[#bda895]">3.00 KDA</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="hidden flex-col rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] p-4 shadow-[0_16px_38px_rgba(0,0,0,0.3)] md:flex">
              ...
              {matchData?.map((match) => {
                ...
                return (
                  <div
                    ...
                    className="flex flex-col overflow-hidden rounded-[1.5rem] border border-[#3a2a22] bg-[#18110e] shadow-[0_18px_44px_rgba(0,0,0,0.32)]"
                  >
                    {/* 요약 카드 */}
                    <div
                      className={`flex cursor-pointer items-center justify-between gap-4 border-l-4 bg-[#18110e] p-4 transition-colors hover:bg-[#211713] ${
                        match.myData.win
                          ? "border-l-[#4f9cff]"
                          : "border-l-[#ff6b78]"
                      }`}
                    >
                      <div className="flex w-24 shrink-0 flex-col items-start justify-center gap-1">
                        ...
                        <div className="text-xs font-medium text-[#bda895]">
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex flex-col justify-center">
                              <div className="flex gap-1 text-lg font-bold">
                                ...
                                <span>/</span>
                                <span className="text-[#ff6b78]">
                                  {match.myData.deaths}
                                </span>
                                <span>/</span>
                                <span>{match.myData.assists}</span>
                              </div>
                              <p className="text-xs font-semibold text-[#bda895]">
                                {match.myData.kda
                                  ? match.myData.kda.toFixed(2)
                                  : ""}
                                KDA
                              </p>
                              <div className="mt-1 text-xs text-[#bda895]">
                                {kill(match)}
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="flex min-w-[5rem] flex-col items-center justify-center rounded-2xl bg-[#241914] px-4 py-3">
                          <h5 className="text-xs font-semibold text-[#bda895]">
                            AI-Score
                          </h5>
                          <div className="text-2xl font-bold text-[#fbbf24]">
                            {match.myData.ourScore}
                          </div>
                          <div className="text-xs text-[#bda895]">몇 등</div>
                        </div>
                      </div>
                      {/* 팀 1 (0-4번 플레이어) */}
                      <div className="flex w-32 flex-col gap-1 text-xs text-[#d1bca8]">
                        {team1Players.map((playerIndex) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                className="cursor-pointer overflow-hidden text-ellipsis whitespace-nowrap hover:text-[#5aa2ff]"
                                onClick={(e) => {
                                  e.stopPropagation();
                                  router.push(
                      ...
                      <button
                        ...
                        className={`flex h-12 w-12 items-center justify-center rounded-2xl transition-colors ${
                          match.myData.win
                            ? "bg-[#102944] text-[#5aa2ff] hover:bg-[#143353]"
                            : "bg-[#3a1821] text-[#ff6b78] hover:bg-[#4a1e2a]"
                        }`}
                      >
                        <svg
                    ...
                    {/* 확장된 상세 정보 */}
                    {isExpanded && (
                      <div className="overflow-hidden border-t border-[#3a2a22] bg-[#18110e] text-[#fff8ef]">
                        {/* 탭 네비게이션 */}
                        <div className="flex gap-2 border-b border-[#3a2a22] bg-[#120d0a] px-4 py-3">
                          <button className="rounded-full bg-[#f59e0b] px-4 py-2 text-sm font-bold text-[#120d0a]">
                            AI 기본 분석
                          </button>
                          <button className="rounded-full px-4 py-2 text-sm font-semibold text-[#bda895] hover:bg-[#241914] hover:text-[#fff8ef]">
                            시간대별 분석
                          </button>
                          <button className="rounded-full px-4 py-2 text-sm font-semibold text-[#bda895] hover:bg-[#241914] hover:text-[#fff8ef]">
                            빌드
                        ...
                        <div
                          className={`${
                            team1Lost ? "bg-[#221114]" : "bg-[#111929]"
                          }`}
                        >
                          <div className="flex items-center gap-2 border-b border-[#3a2a22] px-4 py-3">
                            <span
                              className={`font-medium ${
                                team1Lost ? "text-[#ff6b78]" : "text-[#5aa2ff]"
                              }`}
                            >
                              {team1Lost ? "패배" : "승리"}
                            </span>
                            <span className="text-sm text-[#bda895]">
                              (블루팀)
                            </span>
                          </div>
                          <table className="w-full text-sm text-[#fff8ef]">
                            <thead>
                              <tr className="border-b border-[#3a2a22] text-xs text-[#bda895]">
                            ...
                            <tbody>
                              {team1Players.map((i) => {
                                ...
                                return (
                                  <tr
                                    key={i}
                                    className="border-b border-[#3a2a22] hover:bg-[#241914]"
                                  >
                                    <td className="py-2 px-4">
                                      <div className="flex items-center gap-2">
                                        <div className="relative">
                                          ...
                                          />
                                          <span className="absolute -bottom-1 -left-1 rounded bg-[#120d0a] px-1 text-[10px] text-white">
                                            {p.champLevel}
                                          </span>
                                        </div>
                                        ...
                                        <div className="flex flex-col">
                                          <span
                                            className="cursor-pointer text-sm font-semibold hover:text-[#5aa2ff]"
                                            onClick={() =>
                                              router.push(
                                    ...
                                    <td className="text-center py-2 px-2">
                                      <div className="flex flex-col items-center">
                                        <span className="text-lg font-bold text-[#5aa2ff]">
                                    ...
                                    <td className="text-center py-2 px-2">
                                      <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-xs text-[#bda895]">
                                    ...
                                    <td className="text-center py-2 px-2">
                                      <div className="flex flex-col items-center">
                                        ...
                                        <div className="h-1 w-16 overflow-hidden rounded bg-[#3a2a22]">
                                          <div
                                            className="h-full bg-[#ff6b78]"
                                            style={{
                                              width: `${Math.min(
                                                100,
                                      ...
                                      <div className="flex gap-0.5 justify-center">
                                        {[
                                          ...
                                          itemId > 0 ? (
                                            ...
                                            <div
                                              key={idx}
                                              className="h-6 w-6 rounded-lg bg-[#3a2a22]"
                                            ></div>
                                          )
                                        )}
                                      </div>
